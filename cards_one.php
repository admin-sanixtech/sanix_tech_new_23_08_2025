    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="/images/data_engineering.png" class="card-img-top" alt="Data Engineering">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="/images/cloud_services.png" class="card-img-top" alt="Cloud Services">
                <div class="card-body">
        ...
        <!-- Industrial Grade Project Solutions -->
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="/images/industrial_projects.png" class="card-img-top" alt="Industrial Projects">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="/images/training.png" class="card-img-top" alt="Training and Certification">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="/images/it_staffing_consulting.png" class="card-img-top" alt="IT Staffing">
                <div class="card-body">
        ...
        <!-- Mock Interviews and Career Help -->
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="/images/mock_interviews.png" class="card-img-top" alt="Career Help">
                <div class="card-body">
