...
include 'css_content.php';
include 'menu.php';
include 'header.php';
include 'slider_content.php';
include 'js_content.php';
			...
			<div class="container">	
				<div class="header-left">
					<ul class="pull-left">
						<li>
							<a href="#">
								<i class="fa fa-phone" aria-hidden="true"></i> +9849775399
							</a>
						</li><!--/li-->
						<li>
							<a href="#">
								<i class="fa fa-envelope" aria-hidden="true"></i>info@sanixtech.in
							</a>
						</li><!--/li-->
					</ul><!--/ul-->
				</div><!--/.header-left -->
