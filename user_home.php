  ...
  <body>
    <div class="wrapper">
      ...
      <div class="main">
       ...
       <!-- <?php 
echo "<h3>Listing ../ directory contents:</h3>";
$dir = dirname(__DIR__); // points to /DEV
$files = scandir($dir);
...
<?php
$jobContent = realpath(__DIR__ . '/../job_posts_content.php');

if ($jobContent && file_exists($jobContent)) {
    include $jobContent;
} else {
    echo "<strong style='color:red;'>Error:</strong> job_posts_content.php not found at expected path: " . __DIR__ . '/../job_posts_content.php';
}
