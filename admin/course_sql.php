...
$category_id = 5; // Update if your Python category ID is different
...
// Store all posts into an array so we can use it multiple times
$posts = [];
...
// echo "<pre>Total rows: " . count($posts) . "</pre>";
// print_r($posts);
?>
