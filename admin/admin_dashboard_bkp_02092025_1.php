...
<html lang="en" data-bs-theme="dark">
  <head>
    ...
    <style>
        ...
        /* Add this CSS to your admin_styleone.css or in the <style> section of admin_dashboard.php */
...
#sidebar {
    ...
    height: 100vh;
    overflow-y: auto;
    z-index: 1050; /* Increased from 1000 to ensure it's above other content */
    top: 0;
    left: 0;
}
...
/* Fix modal z-index */
.modal {
    z-index: 1055; /* Higher than sidebar */
}

.modal-backdrop {
    z-index: 1054; /* Just below modal */
}

/* Ensure content doesn't interfere with sidebar */
.content {
    position: relative;
    z-index: 2;
    padding: 20px;
    pointer-events: auto; /* Ensure content is clickable where it should be */
}

/* Fix for welcome section and other content overlapping */
.welcome-section,
.modern-card,
.stats-card,
.chart-container {
...
@media (max-width: 768px) {
    #sidebar {
        margin-left: -250px;
        z-index: 1055; /* Even higher on mobile */
    }
...
/* Fix for navbar to not interfere */
.navbar {
    position: relative;
...
/* Fix for content modal styles from admin_menu */
...
.content-box .badge {
  ...
  <body>
    ...
    <script>
        ...
        // Add this JavaScript to your admin_dashboard.php or create a separate JS file
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleSidebar() {
        ...
        if (window.innerWidth <= 768) {
            sidebar.classList.toggle('show');
            // Add overlay class to body for mobile
    ...
    // Make sure toggle function is globally available
    ...
    // Fix for modal triggers - ensure they work properly
    document.addEventListener('click', function(event) {
        ...
        if (modalTrigger) {
            ...
            const modalTarget = modalTrigger.getAttribute('data-bs-target');
            if (modalTarget) {
    ...
    sidebarLinks.forEach(link => {
        link.addEventListener('click', function(event) {
            // If it's a modal trigger, handle it specially
...
// Additional function to ensure modals work from anywhere
