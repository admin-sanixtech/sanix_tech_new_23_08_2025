        ...
        <li><a href="https://www.sanixtech.in">Home</a></li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="https://www.sanixtech.in/industry_st_projects.php">Industry Standard Projects</a></li>
                    <li><a href="https://www.sanixtech.in/academic_projects.php">Acedemic Projects</a></li>
                    <li><a href="https://www.sanixtech.in/data_migration.php">Data Migration</a></li>
                </ul>
            </li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="https://www.sanixtech.in/datascience_course.php">Data Science</a></li>
                    <li><a href="https://www.sanixtech.in/web_development.php">Web Development</a></li>
                    <li><a href="https://www.sanixtech.in/machine_learning.php">Machine Learning</a></li>
                </ul>
            </li>
            <li class="dropdown">
